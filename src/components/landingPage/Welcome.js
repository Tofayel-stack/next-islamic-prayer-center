            ...
            <section className="bg-white dark:bg-gray-900 py-24">
                <div className="container px-6 py-10 mx-auto">
                    ...
                    <div className="mt-8 lg:-mx-6 lg:flex lg:items-center">
                        <img className="object-cover w-full lg:mx-6 lg:w-1/2 rounded-xl h-72 lg:h-96" src="https://www.ucf.edu/wp-content/blogs.dir/20/files/2021/04/Ramadan-Celebration.jpg" alt="pic"/>
