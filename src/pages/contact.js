        ...
        <div>
                 ...
                 <div className={`bg-[url("https://i.ibb.co/ZmThCF5/services-head-1.png")] h-[469px] }`}>
                    <div className='text-white  flex flex-col justify-center items-center  h-96'>
                        ...
                        <p className='py-6'>home? Contact </p>
                    </div>
                </div>
                            ...
                            <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3">
                                <div class="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-1">
                                    <div>
                                        ...
                                        <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">ekrasupport@gmail.com</p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">360 Warner Street.Miai FL 33141 – USA</p>
                                        <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">100 Smith Street Collingwood USA</p>
                                    </div>
